...
2. Move error_priority and command_timeout_seconds out of the per-task config tables (nextdns_setup_system_wide, i2pd_service_setup, tor_setup, yggdrasil_service_setup, system_metrics_setup, local_vault_setup) into the [engine] table, the way dnscrypt_setup already reads them from engine.error_priority and engine.command_timeout_seconds.
