...
username, home_dir and config_dir, the target user and that user's home and config directories. The live session bus of that user comes from the [engine] table: desktop_username, session_environment_command, session_environment_keys and session_bus_key.  
