...
apply_hotkeys_script_file_name, the name of the task data file that carries the DBus client of the live apply; the task reads it under task_data/kde_keyboard_setup and reports a missing file instead of running it.  
