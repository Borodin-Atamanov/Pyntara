...
config coverage tests (every section has a parser, every key is read, every config file contributes a table, the test document mirrors the repository config)
