...
Approved module constants recorded here: GOOGLE_SCRIPT_ENTRY in pyntara.metrics_send, the vault entry title of the Google Drive web app credentials, fixed by docs/spec/secrets-model.md and mirroring the ENTRY_TITLE constant of secrets/read_google_script_credentials.py.
