...
inst.sh bootstrap core: root check, FHS directories, apt update before install, uv install, git fetch, uv sync, vault password resolution through check-vault.  
