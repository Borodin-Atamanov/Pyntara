...
def base_config() -> str:
    ...
    return (
        ...
        'kwin_reload_command = ["qdbus6", "org.kde.KWin", "/KWin", "org.kde.KWin.reconfigure"]\n'
        'python_script_command = ["{python}", "-c"]\n'
        'kwin_desktop_count_command = ["qdbus6", "org.kde.KWin", '
        '"/VirtualDesktopManager", "org.kde.KWin.VirtualDesktopManager.count"]\n'
        'kwin_desktop_create_command = ["qdbus6", "org.kde.KWin", '
        '"/VirtualDesktopManager", '
        '"org.kde.KWin.VirtualDesktopManager.createDesktop", "{position}", '
        '"{desktop_name}"]\n'
        'kwin_desktop_remove_command = ["qdbus6", "org.kde.KWin", '
        '"/VirtualDesktopManager", '
        '"org.kde.KWin.VirtualDesktopManager.removeDesktop", "{desktop_id}"]\n'
