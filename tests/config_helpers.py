...
def base_config() -> str:
    ...
    return (
        ...
        'report_record_keys = { channel = "channel", address = "address", port = "port", proxy = "proxy", ssh = "ssh", note = "note", server = "server", local_port = "local_port", remote_port = "remote_port", family = "family", interface = "interface", scope = "scope", word = "word", in_country = "in_country", values = "values", answers = "answers", source = "source", raw = "raw", reason = "reason" }\n'
        ...
        'virtual_desktop_manager_object_path = "/VirtualDesktopManager"\n'
        'virtual_desktop_manager_interface_name = "org.kde.KWin.VirtualDesktopManager"\n'
        'virtual_desktops_property_name = "desktops"\n'
        'dbus_properties_interface_name = "org.freedesktop.DBus.Properties"\n'
        'kwin_desktop_count_command = ["qdbus6", "{kwin_bus_name}", '
        '"{virtual_desktop_manager_object_path}", '
        '"{virtual_desktop_manager_interface_name}.count"]\n'
        'kwin_desktop_create_command = ["qdbus6", "{kwin_bus_name}", '
        '"{virtual_desktop_manager_object_path}", '
        '"{virtual_desktop_manager_interface_name}.createDesktop", "{position}", '
        '"{desktop_name}"]\n'
        'kwin_desktop_remove_command = ["qdbus6", "{kwin_bus_name}", '
        '"{virtual_desktop_manager_object_path}", '
        '"{virtual_desktop_manager_interface_name}.removeDesktop", "{desktop_id}"]\n'
