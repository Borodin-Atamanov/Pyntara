...
def base_config() -> str:
    ...
    return (
        ...
        'places_bookmark_namespace = "http://freedesktop.org/standards/desktop-bookmarks"\n'
        'places_kdepriv_namespace = "http://www.kde.org/kdepriv"\n'
        'places_mime_namespace = "http://freedesktop.org/standards/shared-mime-info"\n'
