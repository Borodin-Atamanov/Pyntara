...
def make_config(
    *,
    ...
    tor_service_unit_name: str = "tor.service",
    tor_torrc_path: Path = Path("/etc/tor/torrc"),
    tor_torrc_dropin_path: Path = Path("/etc/tor/torrc.d/pyntara.conf"),
    tor_torrc_include_glob: str = "/etc/tor/torrc.d/*.conf",
    tor_dropin_file_mode: int = 0o640,
    ...
    return Config(
        ...
        tor_setup=TorSetupConfig(
            ...
            torrc_include_glob=tor_torrc_include_glob,
