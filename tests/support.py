...
def make_config(
    *,
    ...
    nextdns_dnscrypt_config_path: Path = Path(
        "/etc/dnscrypt-proxy/dnscrypt-proxy.toml"
    ),
    nextdns_profile_id_file_path: Path = Path("/var/lib/pyntara/nextdns_profile_id"),
    nextdns_profile_id_file_mode: int = 0o644,
    nextdns_doh_url_format: str = "https://dns.nextdns.io/{profile_id}",
    nextdns_dot_stamp_host_format: str = "{profile_id}.dns.nextdns.io:853",
    nextdns_doq_stamp_host_format: str = "quic://{profile_id}.dns.nextdns.io:853",
    nextdns_static_name_prefix: str = "nextdns-profile",
    nextdns_verification_url: str = "https://test.nextdns.io/",
    nextdns_restart_proxy_command: tuple[str, ...] = (
        "systemctl",
        "restart",
        "dnscrypt-proxy",
    ),
    ...
    return Config(
        ...
        nextdns_setup_system_wide=NextdnsSetupSystemWideConfig(
            ...
            dnscrypt_config_path=nextdns_dnscrypt_config_path,
            profile_id_file_path=nextdns_profile_id_file_path,
            profile_id_file_mode=nextdns_profile_id_file_mode,
            doh_url_format=nextdns_doh_url_format,
            dot_stamp_host_format=nextdns_dot_stamp_host_format,
            doq_stamp_host_format=nextdns_doq_stamp_host_format,
            static_name_prefix=nextdns_static_name_prefix,
            verification_url=nextdns_verification_url,
            restart_proxy_command=nextdns_restart_proxy_command,
