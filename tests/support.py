...
def make_config(
    *,
    ...
    dnsproxy_listen_address: str = "127.0.0.1",
    dnsproxy_listen_port: int = 53053,
    dnsproxy_fallback_resolvers: tuple[str, ...] = ("1.1.1.1", "8.8.8.8"),
    ...
    return Config(
        ...
        dnsproxy_setup=DnsproxySetupConfig(
            ...
            listen_address=dnsproxy_listen_address,
            ...
            cache_enabled=True,
            fallback_resolvers=dnsproxy_fallback_resolvers,
