...
def make_config(
    *,
    ...
    i2pd_socks_proxy_port: int = 4447,
    ...
    three_x_ui_connection_vault_entry_title: str = "xray_connection",
    three_x_ui_share_addr_strategy: str = "custom",
    ...
    three_x_ui_reality_fingerprint: str = "chrome",
    three_x_ui_subscription_path: str = "/s/",
    three_x_ui_subscription_json_path: str = "/j/",
    three_x_ui_subscription_clash_path: str = "/c/",
    ...
    three_x_ui_upnp_client_command: str = "upnpc",
    three_x_ui_upnp_mapping_description: str = "pyntara xray",
    ...
    vocalinux_username: str = "i",
    vocalinux_home_dir: str = "/home/i",
    vocalinux_download_dir: Path = Path("/var/cache/pyntara/vocalinux"),
    vocalinux_version: str = "0.16.2",
    vocalinux_packages: tuple[str, ...] = (
        "wtype",
        "ydotool",
        "wl-clipboard",
        "libkf6config-bin",
    ),
    vocalinux_input_group: str = "input",
    vocalinux_service_unit_name: str = "ydotool.service",
    vocalinux_package_status_timeout_seconds: int = 30,
    vocalinux_package_install_retries: int = 3,
    ...
    return replace(
        ...
        kde_settings=replace(
            ...
            user_dirs=(
                ...
                else base.kde_settings.user_dirs
            ),
        ...
        i2pd_service_setup=replace(
            ...
            socks_proxy_port=i2pd_socks_proxy_port,
        ...
        three_x_ui_xray_setup=replace(
            ...
            connection_vault_entry_title=three_x_ui_connection_vault_entry_title,
            share_addr_strategy=three_x_ui_share_addr_strategy,
            ...
            reality_fingerprint=three_x_ui_reality_fingerprint,
            subscription_path=three_x_ui_subscription_path,
            subscription_json_path=three_x_ui_subscription_json_path,
            subscription_clash_path=three_x_ui_subscription_clash_path,
        ...
        vocalinux_setup=replace(
            ...
            version=vocalinux_version,
            packages=vocalinux_packages,
            input_group=vocalinux_input_group,
            service_unit_name=vocalinux_service_unit_name,
            package_status_timeout_seconds=(
                vocalinux_package_status_timeout_seconds
            ),
