...
def make_config(
    *,
    ...
    engine_desktop_username: str = "i",
    engine_session_environment_command: tuple[str, ...] = (
        "systemctl",
        "--machine",
        "{username}@.host",
        "--user",
    ...
    engine_session_environment_keys: tuple[str, ...] = (
    ...
    engine_session_bus_key: str = "DBUS_SESSION_BUS_ADDRESS",
    engine_session_display_keys: tuple[str, ...] = ("WAYLAND_DISPLAY", "DISPLAY"),
    ...
    i2pd_address_check_attempts: int = 10,
    i2pd_address_check_retry_delay_seconds: float = 0.0,
    i2pd_config_template_file_name: str = "i2pd.conf",
    i2pd_tunnels_template_file_name: str = "tunnels.conf",
    i2pd_codename_asset_name_template: str = (
        "i2pd_{release_tag}-1{codename}1_{arch}.deb"
    ),
    i2pd_generic_asset_name_template: str = "i2pd_{release_tag}-1_{arch}.deb",
    i2pd_os_release_codename_key: str = "VERSION_CODENAME",
    i2pd_version_command: tuple[str, ...] = ("i2pd", "--version"),
    i2pd_service_enable_command: tuple[str, ...] = (
        "systemctl",
        "enable",
        "{service_unit_name}",
    ),
    i2pd_service_start_command: tuple[str, ...] = (
        "systemctl",
        "start",
        "{service_unit_name}",
    ),
    i2pd_service_restart_command: tuple[str, ...] = (
        "systemctl",
        "restart",
        "{service_unit_name}",
    ),
    i2pd_config_true_value: str = "true",
    i2pd_config_false_value: str = "false",
    ...
    return replace(
        ...
        engine=replace(
            ...
            session_environment_command=engine_session_environment_command,
        ...
        i2pd_service_setup=replace(
            ...
            generic_asset_name_template=i2pd_generic_asset_name_template,
            os_release_codename_key=i2pd_os_release_codename_key,
            version_command=i2pd_version_command,
            service_enable_command=i2pd_service_enable_command,
            service_start_command=i2pd_service_start_command,
            service_restart_command=i2pd_service_restart_command,
            config_true_value=i2pd_config_true_value,
            config_false_value=i2pd_config_false_value,
        ),
        ...
        tor_setup=replace(
            ...
            torrc_comment_sign=tor_torrc_comment_sign,
