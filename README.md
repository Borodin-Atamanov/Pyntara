...
[docs/spec/chrome-setup.md](docs/spec/chrome-setup.md) — Google Chrome install from the official apt repository, browser settings from the chromium-default-settings repository and the CDP desktop entry  
