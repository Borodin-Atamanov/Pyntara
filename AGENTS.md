...
Удалять можно только так, чтобы можно было восстановить.
...
Ты должна объяснять понятно, что ты делаешь и зачем - до действий и во время, а не после. Если находишь новый факт важный в процессе рассуждения - ёмко о нём пишешь в процессе, не просто "найдена серьёзная причина", а написать какая.
...
Ты пытаешься найти способы упрощения, избавиться от лишней сложности и хрупкости! Думаешь и находишь решения: Как достичь целей с минимальной сложностью? Как сделать минимум проверок, как написать минимум документации и кода, но решить задачу?
