# Pyntara — техническое задание для ИИ-агентов

## Оглавление
1. [Назначение и контекст проекта](#1-назначение-и-контекст-проекта)
2. [Запуск и первичная загрузка](#2-запуск-и-первичная-загрузка)
3. [Режимы установки и выбор задач](#3-режимы-установки-и-выбор-задач)
4. [Секреты и пароли](#4-секреты-и-пароли)
5. [Модель задач и идемпотентность](#5-модель-задач-и-идемпотентность)
6. [Редактирование конфигураций](#6-редактирование-конфигураций)
7. [Телеметрия](#7-телеметрия)
8. [Сетевые функции, прокси и доступ](#8-сетевые-функции-прокси-и-доступ)
9. [Пользователи, хост и системные настройки](#9-пользователи-хост-и-системные-настройки)
10. [Приложения, GUI и рабочая среда](#10-приложения-gui-и-рабочая-среда)
11. [Логи и сервисы](#11-логи-и-сервисы)
12. [Архитектурные и кодовые стандарты](#12-архитектурные-и-кодовые-стандарты)
13. [Тестирование и CI-правила](#13-тестирование-и-ci-правила)
14. [Требования к стилю документации и комментариям](#14-требования-к-стилю-документации-и-комментариям)
15. [Открытый архитектурный вопрос](#15-открытый-архитектурный-вопрос)
16. [Правила консолидации исходных сообщений](#16-правила-консолидации-исходных-сообщений)
